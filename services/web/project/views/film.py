...
class PostGenre(Resource):
    ...
    def post(self) -> tuple:
        ...
        """
        try:
            film = FilmModel(title=request.json['title'], year_release=request.json['year_release'],
                             director_id=request.json['director_id'], description=request.json['description'],
                             rating=request.json['rating'], poster=request.json['poster'],
